...
{
    private readonly IEventsBLL _eventBLL;
    private UserDTO user = null;
    public EventsController(IEventsBLL eventBLL)
    {
        _eventBLL = eventBLL;
    ...
    public IActionResult Index()
    {
        ...
        var model = _eventBLL.GetAllEvents();
        return View(model);
    }
    ...
    public IActionResult Detail(int id)
    {
        ...
        var model = _eventBLL.GetEventById(id);
        return View(model);
    }
    ...
    [HttpPost]
    public IActionResult Create(CreateEventsDTO eventCreate)
    {
        try
        {
            _eventBLL.AddEvent(eventCreate);
    ...
    [HttpPost]
    public IActionResult Edit(int id, UpdateEventsDTO eventEdit)
    {
        try
        {
            _eventBLL.UpdateEvent(eventEdit);
    ...
    {
        var categories = _eventBLL.GetAllEvents();
    ...
    public IActionResult DisplayDropdownList(string CategoryID)
    {
        ...
        ViewBag.Categories = _eventBLL.GetAllEvents();
